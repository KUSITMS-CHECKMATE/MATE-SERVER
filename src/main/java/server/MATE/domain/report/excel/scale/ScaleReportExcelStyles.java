...
record ScaleReportExcelStyles(
    ...
    private static final byte[] SECTION_GREEN = {(byte) 112, (byte) 173, (byte) 71};
    private static final byte[] LABEL_GREEN = {(byte) 198, (byte) 239, (byte) 206};

    static ScaleReportExcelStyles create(Workbook workbook) {
        return new ScaleReportExcelStyles(
                ...
                createQuestionTextStyle(workbook),
    ...
    private static XSSFCellStyle createSectionHeaderStyle(Workbook workbook) {
        XSSFCellStyle style = coloredStyle(workbook, SECTION_GREEN);
        style.setAlignment(HorizontalAlignment.CENTER);
        style.setVerticalAlignment(VerticalAlignment.CENTER);
    ...
    private static XSSFCellStyle createQuestionTextStyle(Workbook workbook) {
