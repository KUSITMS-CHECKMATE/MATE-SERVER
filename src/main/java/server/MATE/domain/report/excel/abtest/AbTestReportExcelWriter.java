...
public class AbTestReportExcelWriter {
    ...
    private int writeSectionTitleRow(Sheet sheet, int rowIndex, AbTestReportExcelStyles styles) {
        ...
        mergeRow(row, 0, CONTENT_LAST_COLUMN, styles.sectionHeader());
        return rowIndex + 1;
    }
    ...
    private int writeQuestionTextRow(
        ...
        mergeRow(row, 1, CONTENT_LAST_COLUMN, styles.greenValue());
        return rowIndex + 1;
    }
    ...
    private int writeVersionRows(Sheet sheet, int rowIndex, AbTestReportExcelData data, AbTestReportExcelStyles styles) {
        ...
        mergeRow(versionARow, 1, CONTENT_LAST_COLUMN, styles.countValue());
        ...
        mergeRow(versionBRow, 1, CONTENT_LAST_COLUMN, styles.countValue());
        return rowIndex + 2;
    }
