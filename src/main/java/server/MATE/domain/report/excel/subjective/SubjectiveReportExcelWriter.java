...
public class SubjectiveReportExcelWriter {
    ...
    public int writeToSheet(
            Sheet sheet,
            int startRowIndex,
            SubjectiveReportExcelData data,
    ...
    private int writeQuestionTextRow(
        ...
        mergeRow(row, 1, CONTENT_LAST_COLUMN, styles.questionText());
        return rowIndex + 1;
    }
    ...
    private int writeTableHeaderRow(Sheet sheet, int rowIndex, SubjectiveReportExcelStyles styles) {
        ...
        mergeRow(row, 1, CONTENT_LAST_COLUMN, styles.tableHeader());
        return rowIndex + 1;
    }
    ...
    private int writeRespondentRows(
        ...
        for (int index = 0; index < respondents.size(); index++) {
            ...
            mergeRow(row, 1, CONTENT_LAST_COLUMN, styles.data());
        }
