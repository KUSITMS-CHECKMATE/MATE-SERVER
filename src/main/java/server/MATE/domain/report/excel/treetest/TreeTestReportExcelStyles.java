...
record TreeTestReportExcelStyles(
    ...
    static TreeTestReportExcelStyles create(Workbook workbook) {
        return new TreeTestReportExcelStyles(
    ...
    private static XSSFCellStyle createPathDataStyle(Workbook workbook) {
        XSSFCellStyle style = coloredStyle(workbook, VALUE_YELLOW);
        style.setAlignment(HorizontalAlignment.LEFT);
        style.setVerticalAlignment(VerticalAlignment.CENTER);
        style.setWrapText(true);
