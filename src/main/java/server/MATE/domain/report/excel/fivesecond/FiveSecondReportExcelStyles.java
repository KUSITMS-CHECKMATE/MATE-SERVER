...
record FiveSecondReportExcelStyles(
        CellStyle questionSettingHeader,
        CellStyle label,
        CellStyle value,
        CellStyle sectionHeader,
        CellStyle statsSectionHeader,
    ...
    private static final byte[] SECTION_ORANGE = {(byte) 237, (byte) 125, (byte) 49};
    private static final byte[] STATS_ORANGE = {(byte) 198, (byte) 89, (byte) 17};
    private static final byte[] LABEL_GREEN = {(byte) 198, (byte) 239, (byte) 206};

    static FiveSecondReportExcelStyles create(Workbook workbook) {
        return new FiveSecondReportExcelStyles(
                createQuestionSettingHeaderStyle(workbook),
                createLabelStyle(workbook),
                createPlainValueStyle(workbook),
                createSectionHeaderStyle(workbook, SECTION_ORANGE),
                createSectionHeaderStyle(workbook, STATS_ORANGE),
    ...
    private static XSSFCellStyle createSectionHeaderStyle(Workbook workbook, byte[] rgb) {
        XSSFCellStyle style = coloredStyle(workbook, rgb);
        style.setAlignment(HorizontalAlignment.CENTER);
        style.setVerticalAlignment(VerticalAlignment.CENTER);
    ...
    private static XSSFCellStyle createDataStyle(Workbook workbook) {
