...
public class TreeTestReportExcelWriter {
    ...
    private int writeSectionTitleRow(Sheet sheet, int rowIndex, TreeTestReportExcelStyles styles) {
        ...
        mergeRow(row, STAT_PATH_FIRST_COLUMN, LAST_COLUMN, styles.sectionHeader());
        return rowIndex + 1;
    }
    ...
    private int writeQuestionAndStatHeaderRow(Sheet sheet, int rowIndex, TreeTestReportExcelStyles styles) {
        ...
        mergeRow(row, STAT_PATH_FIRST_COLUMN, STAT_PATH_LAST_COLUMN, styles.tableHeader());
    ...
    private int writeDataRows(
        ...
        for (int relativeRow = 0; relativeRow < rowCount; relativeRow++) {
            ...
            writeStatCells(row, relativeRow, pathStats, data.totalResponseCount(), styles);
        }
    ...
    private void writeStatCells(
        ...
        if (index < pathStats.size()) {
            ...
            mergeRow(row, STAT_PATH_FIRST_COLUMN, STAT_PATH_LAST_COLUMN, styles.pathData());
        ...
        if (index == pathStats.size()) {
            ...
            mergeRow(row, STAT_PATH_FIRST_COLUMN, STAT_PATH_LAST_COLUMN, styles.totalLabel());
