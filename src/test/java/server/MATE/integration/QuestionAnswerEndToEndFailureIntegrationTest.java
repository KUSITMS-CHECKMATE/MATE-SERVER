...
@ActiveProfiles("test")
class QuestionAnswerEndToEndFailureIntegrationTest {
    ...
    private void createSingleSubjectiveQuestion(Long testId, String makerToken) throws Exception {
        performCreateQuestion(testId, makerToken, singleSubjectiveQuestionPayload());
    }

    private void createTwoSubjectiveQuestions(Long testId, String makerToken) throws Exception {
    ...
    private void createObjectiveQuestion(Long testId, String makerToken, boolean isDuplicate, Integer minSelect, Integer maxSelect, boolean isOther) throws Exception {
        performCreateQuestion(testId, makerToken, """
                {
                  "questions": [
                    {
    ...
    private void createFiveSecondSubjectiveQuestion(Long testId, String makerToken) throws Exception {
        performCreateQuestion(testId, makerToken, """
                {
                  "questions": [
                    {
    ...
    private void createFiveSecondObjectiveQuestion(Long testId, String makerToken, boolean isDuplicate, Integer minSelect, Integer maxSelect, boolean isOther) throws Exception {
        performCreateQuestion(testId, makerToken, """
                {
                  "questions": [
                    {
    ...
    private void createScaleQuestion(Long testId, String makerToken, int range) throws Exception {
        performCreateQuestion(testId, makerToken, """
                {
                  "questions": [
                    {
    ...
    private void createAbTestQuestion(Long testId, String makerToken) throws Exception {
        performCreateQuestion(testId, makerToken, """
                {
                  "questions": [
                    {
    ...
    private void createCardSortingQuestion(Long testId, String makerToken) throws Exception {
        performCreateQuestion(testId, makerToken, """
                {
                  "questions": [
                    {
    ...
    private void createTreeTestQuestion(Long testId, String makerToken) throws Exception {
        performCreateQuestion(testId, makerToken, """
                {
                  "questions": [
                    {
    ...
    private void performCreateQuestion(Long testId, String token, String payload) throws Exception {
    ...
    private JsonNode getSingleQuestion(Long testId, String token) throws Exception {
        JsonNode questions = getQuestionsArray(testId, token);
        assertThat(questions).hasSize(1);
        return questions.get(0);
    }

    private JsonNode getQuestionsArray(Long testId, String token) throws Exception {
    ...
    private JsonNode submitAnswerExpectSuccess(Long testId, String token, String payload) throws Exception {
    ...
    private JsonNode submitAnswerExpectingError(Long testId, String token, String payload, int statusCode, String code) throws Exception {
    ...
    private JsonNode performExpectingError(org.springframework.test.web.servlet.request.MockHttpServletRequestBuilder builder,
                                           int statusCode,
    ...
    private String singleSubjectiveQuestionPayload() {
        return """
                {
                  "questions": [
                    {
    ...
    private String jsonValue(Integer value) {
